              ...
              >
                <article className="py-6 lg:py-10 px-6 lg:px-16 block focus:outline-none focus:ring-4">
                  ...
                  <div className="lg:flex gap-5 pt-5">
                    ...
                    {/* Contentful Data */}
                    <div className="lg:w-1/2">
                      <p className="flex gap-4 dark:text-cyan-500 text-xl font-bold p-3 border-sky-900 border-2 border-solid dark:border-cyan-500">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="30"
                          height="30"
                      ...
                      {/* WordPress Data */}
                      <p className="flex gap-4 dark:text-cyan-500 mt-3 text-xl font-bold p-3 border-2 border-solid dark:border-cyan-500 border-sky-900">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="30"
                          height="30"
                          viewBox="0 0 30 30"
                          aria-hidden="true"
                          className="!tw-fill-current dark:fill-white tw-h-4 tw-w-4"
                        >
